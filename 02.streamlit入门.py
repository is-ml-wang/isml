...
#图片
st.image("resource/暗黑 玛奇玛 电锯人 霓虹 黑色背景 4K壁纸 3840x2160_彼岸图网.jpg")
#音频
st.audio("resource/DOUDOU - 嗵嗵.mp3")
#视频
st.video("resource/IMG_4267.MP4")
#logo
st.logo("resource/preview_png.png")
#表格
stu = {
    "姓名":["袁通","圆通","圆筒","源通"],
    "学号":["666","1","0","888"],
